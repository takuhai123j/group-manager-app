...
export const HELP_CONTENT = {
  ...
  meetingPlan: {
    items: [
      {
        title: '年間計画の見方',
        description: '施設ごとに「施設MT」「厨房内MT」の2行があり、1〜12月のマスでその月の状態を確認できます。',
      },
      {
        title: 'マスを押して操作する',
        description: 'マスを押すと詳細が開きます。まだ計画がない月はその場でMTを手動追加でき、計画済みの月は日程の確定・変更・取消ができます。',
      },
      {
        title: '頻度設定',
        description: '「頻度設定」タブで施設・MT種別ごとに開催頻度（何か月ごと・開始月）を設定・保存すると、選択中の年の計画が自動生成されます。',
      },
      {
        title: '期限超過の表示',
        description: '予定日（または計画月の月末）を過ぎても未実施のMTは「期限超過」として赤色で表示されます。',
      },
      {
        title: 'サマリーカード',
        description: '画面上部のカードで「今月のMT」「期限超過」「議事録未登録」「議事録登録済」の件数を確認できます。カードを押すと対象一覧が開き、そこから直接MTを開けます。',
      },
      {
        title: 'G長別に絞り込む',
        description: '「表示対象」で特定のG長を選ぶと、そのG長の担当施設のみに絞って年間計画とサマリーを確認できます。',
      },
    ],
    commonMistake: {
      title: '頻度設定を変更しても計画が更新されない',
      description: '頻度設定は保存時に選択中の年の計画を自動再生成しますが、日程確定済・実施済・議事録ありのMTは保護され変更されません。年を切り替えて確認してください。',
    },
  },
} as const
